...
export LIFETODO_LARK_COMPLETION_TABLE_ID=tbluon5aF9IrHMIv
...
- `POST /api/completions?home=demo-home`：网页或 ESP32 提交单条完成状态，写入完成状态表，并更新 TODO 行上的最近完成缓存。
...
LIFETODO_LARK_COMPLETION_TABLE_ID=tbluon5aF9IrHMIv
